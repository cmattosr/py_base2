...
Nota: No Python 3.10 tem uma novidade, agora não precisamos mais importar o tipo Union basta usarmos o operador | portanto ao invés de Union[Decimal, int] usamos Decimal | int
